...
--sample date
insert into t_expense values(seq_t_expense_idx.nextVal, '통신비');
insert into t_expense values(seq_t_expense_idx.nextVal, '복리후생비');
insert into t_expense values(seq_t_expense_idx.nextVal, '운송비');
insert into t_expense values(seq_t_expense_idx.nextVal, '지급수수료');
insert into t_expense values(seq_t_expense_idx.nextVal, '상품');
